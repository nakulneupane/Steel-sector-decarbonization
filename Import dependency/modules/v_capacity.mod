...
# Supply capacity cannot be un-built (sunk).
...
#  Production runs below capacity; idle capacity pays fixed opex.
...
# Fixed opex (labour + maintenance) on installed capacity
